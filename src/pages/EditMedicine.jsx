            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full h-11 px-4 rounded-xl border border-stone-200 bg-[#fafaf8] text-slate-800 text-xs font-mono tracking-wider outline-none focus:border-stone-400 focus:bg-white transition"
                />
              </div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full h-11 px-4 rounded-xl border border-stone-200 bg-[#fafaf8] text-slate-800 text-xs font-mono outline-none focus:border-stone-400 focus:bg-white tracking-wide transition"
                />
              </div>
